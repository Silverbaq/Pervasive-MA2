...
public class SerialTest implements SerialPortEventListener {
    ...
    private String saveFilePath = "/home/silverbaq/Documents/data.csv";
    ...
    public void FileCreate() {
        ...
        try {
            file = new FileWriter(new File(saveFilePath));
            file.append("TimeStamp,AccX-average, AccY-average, AccZ-average,GyrX-average, GyrY-average, GyrZ-average,\n");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
